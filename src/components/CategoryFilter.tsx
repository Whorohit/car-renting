...
const CategoryFilter:React.FC<Props> = ({}) => {
  ...
  return (
    ...
    <div className='md:flex hidden flex-row w-[80%] mx-auto justify-start  items-center    gap-4 mt-6   '>
       {items.map((item)=>(
          <button className=' md:text-base md:border-2 md:p-2 hover:scale-90 transition-all duration-100  md:border-neutral-400 md:rounded-md  text-neutral-700 ' key={item.title}>
