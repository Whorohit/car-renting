...
const Carinfo: React.FC<Props> = () => {
  ...
  return (
    <>
      ...
      <div className='mt-32  md:w-full  w-screen '>
        <div className='md:flex flex-col  mx-auto gap-4 w-[95%] md:flex-row'>
          <Carousel className='h-auto w-full md:w-[70%]' showStatus={true}>

            <div>
              <Image quality={100} src={data?.frontimg} alt='nexon.jpg' className='rounded-md border-2 h-64 md:h-[30rem] w-full object-cover' width={100} height={100} />
            </div>
            <div>
              <Image quality={100} src={data?.sideimg} alt='nexon.jpg' className='rounded-md border-2 h-64 md:h-[30rem] w-full object-cover' width={100} height={100} />
            </div>
            <div>
              <Image quality={100} src={data?.backimg} alt='nexon.jpg' className='rounded-md border-2 h-64 md:h-[30rem] w-full object-cover' width={100} height={100} />
            </div>
            <div>
              <Image quality={100} src={data?.coverimg} alt='nexon.jpg' className='rounded-md border-2 h-64 md:h-[30rem] w-full object-cover' width={100} height={100} />
            </div>
          </Carousel>
          <div className='mt-5 md:mt-0 w-full   md:w-[30%]'>
        ...
        <div className='rounded-md  bg-neutral-50 shadow-md lg:w-[62%] lg:ml-20  mt-5 l p-2 '>
          <h1 className=' font-bold text-base  md:text-xl flex  justify-start items-center gap-3 w-[90%] mx-auto text-left  border-b-[1px] border-b-gray-200 py-3 '>
            {data && data?.brand.brandname ? data?.brand.brandname : ""}
            {data && data?.Modal ? data?.Modal : ""} <span>{data && data.verifed ? <MdVerified size={20} color={` blue `} /> : <MdOutlineVerified color={'grey'} size={20} />}</span> <span className='text-gray-400 text-sm'>{data?.verifed ? " verifed" : "Not verifed"} </span></h1>
          <div className='border-b-[1px] border-b-gray-200  min-h-[5rem]  w-[90%] mx-auto pb-5 '>
            ...
            <div className={` flex-col flex justify-between px-2 gap-y-2  transition-transform  mx-auto overflow-hidden  ${toggleoverview ? "min-h-[20rem] " : "max-h-0 "}`} >
              ...
              <div className='flex justify-between gap-x-10  flex-col md:flex-row  '>
                ...
                <h1 className='basis-1/2 flex justify-between gap-x-10 text-neutral-800 font-bold text-sm md:text-base capitalize' >Year<span className='font-semibold text-neutral-500 text-sm'>{data && data?.year ? data.year : ""}</span> </h1>
              </div>
          ...
          <div className=' '>
            ...
            <div className={`flex-col flex justify-between  w-[90%]   transition-transform  mx-auto overflow-hidden   ${toggledes ? "min-h-64 " : "max-h-0 "}`}>
        ...
        <div className='flex flex-row flex-wrap      md:justify-normal w-full xl:w-[80%] mx-auto mt-5 '>
          <div className='w-full  justify-start pt-12  flex flex-col items-start md:w-[70%] gap-4'>
          ...
          <div className='   hidden lg:flex flex-col gap-4  md:w-[25%]'>
